...
struct ChuckModel {
    let chuckJokes = [
        ...
        "CNN was originally created as the 'Chuck Norris Network' to update Americans with on-the-spot @ss kicking in real-time.",
        ...
        "The original draft of The Lord of the Rings featured Chuck Norris instead of Frodo Baggins. It was only 5 pages long, as Chuck roundhouse kicked Sauron's @ss halfway through the first chapter.",
        ...
        "Chuck Norris won super bowls VII and VIII singlehandedly before unexpectedly retiring to pursue a career in @ss-kicking.",
        ...
        "Chuck Norris does not kick @ss and take names. In fact, Chuck Norris kicks @ss and assigns the corpse a number. It is currently recorded to be in the billions.",
        ...
        "Jean-Claude Van Damme once kicked Chuck Norris' @ss. He was then awakened from his dream by a roundhouse kick to the face.",
        ...
        "A man once claimed Chuck Norris kicked his @ss twice, but it was promptly dismissed as false... no one could survive it the first time.",
