...
struct ChuckModel {
    let chuckJokes = [
        ...
        "If you Google search 'Chuck Norris getting his @ss kicked' you will generate zero results. It just doesn't happen.",
        ...
        "Chuck Norris beat Halo 1, 2, 3, 4, 5, and 6 on Legendary with a broken Guitar Hero controller.",
